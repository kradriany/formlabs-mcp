...
[**printers_prints_list**](PrintersApi.md#printers_prints_list) | **GET** /developer/v1/printers/{printer_serial}/prints/ | 
[**printers_retrieve**](PrintersApi.md#printers_retrieve) | **GET** /developer/v1/printers/{printer_serial}/ | 


# **printers_list**
> PaginatedDeveloperAPIMyPrinterList printers_list(page=page, per_page=per_page)
...
with formlabs_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.printers_list(page=page, per_page=per_page)
...
[**PaginatedDeveloperAPIMyPrinterList**](PaginatedDeveloperAPIMyPrinterList.md)
...
with formlabs_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PrintersApi->printers_prints_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PrintersApi->printers_prints_list: %s\n" % e)
```
