...
class TestDeveloperAPIGroupsBulkAddPrintersRequest(unittest.TestCase):
    """DeveloperAPIGroupsBulkAddPrintersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeveloperAPIGroupsBulkAddPrintersRequest:
        """Test DeveloperAPIGroupsBulkAddPrintersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeveloperAPIGroupsBulkAddPrintersRequest`
        """
        model = DeveloperAPIGroupsBulkAddPrintersRequest()
        if include_optional:
            return DeveloperAPIGroupsBulkAddPrintersRequest(
                target_group = '',
                printers = [
                    null
                    ]
    ...
    def testDeveloperAPIGroupsBulkAddPrintersRequest(self):
        """Test DeveloperAPIGroupsBulkAddPrintersRequest"""
