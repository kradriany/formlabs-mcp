...
class TestRequestAnAccessToken401Response(unittest.TestCase):
    """RequestAnAccessToken401Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAnAccessToken401Response:
        """Test RequestAnAccessToken401Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAnAccessToken401Response`
        """
        model = RequestAnAccessToken401Response()
        if include_optional:
            return RequestAnAccessToken401Response(
                error = ''
            )
        else:
            return RequestAnAccessToken401Response(
    ...
    def testRequestAnAccessToken401Response(self):
        """Test RequestAnAccessToken401Response"""
