...
class TestCartridgesApi(unittest.TestCase):
    """CartridgesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CartridgesApi()

    def tearDown(self) -> None:
        pass

    def test_cartridges_list(self) -> None:
        """Test case for cartridges_list
