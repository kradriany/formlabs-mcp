...
class TestMachineTypeIdAdbEnum(unittest.TestCase):
    """MachineTypeIdAdbEnum unit test stubs"""
    ...
    def testMachineTypeIdAdbEnum(self):
        """Test MachineTypeIdAdbEnum"""
        # inst = MachineTypeIdAdbEnum()
