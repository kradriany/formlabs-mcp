...
class TestPrintRunWithFleetControlData(unittest.TestCase):
    """PrintRunWithFleetControlData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintRunWithFleetControlData:
        """Test PrintRunWithFleetControlData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintRunWithFleetControlData`
        """
        model = PrintRunWithFleetControlData()
        if include_optional:
            return PrintRunWithFleetControlData(
                guid = '',
                name = '',
                printer = '',
                status = 'QUEUED',
    ...
    def testPrintRunWithFleetControlData(self):
        """Test PrintRunWithFleetControlData"""
