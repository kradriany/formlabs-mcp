...
class TestPaginatedUserEventReadOnlyList(unittest.TestCase):
    """PaginatedUserEventReadOnlyList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedUserEventReadOnlyList:
        """Test PaginatedUserEventReadOnlyList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedUserEventReadOnlyList`
        """
        model = PaginatedUserEventReadOnlyList()
        if include_optional:
            return PaginatedUserEventReadOnlyList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    formlabs_web_api.models.user_event_read_only.UserEventReadOnly(
                        id = 56, 
                        printer = '', 
    ...
    def testPaginatedUserEventReadOnlyList(self):
        """Test PaginatedUserEventReadOnlyList"""
