...
class TestRequestAnAccessToken400Response(unittest.TestCase):
    """RequestAnAccessToken400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAnAccessToken400Response:
        """Test RequestAnAccessToken400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAnAccessToken400Response`
        """
        model = RequestAnAccessToken400Response()
        if include_optional:
            return RequestAnAccessToken400Response(
                error = '',
                error_description = ''
            )
        else:
    ...
    def testRequestAnAccessToken400Response(self):
        """Test RequestAnAccessToken400Response"""
