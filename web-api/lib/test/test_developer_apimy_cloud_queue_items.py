...
class TestDeveloperAPIMyCloudQueueItems(unittest.TestCase):
    """DeveloperAPIMyCloudQueueItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeveloperAPIMyCloudQueueItems:
        """Test DeveloperAPIMyCloudQueueItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeveloperAPIMyCloudQueueItems`
        """
        model = DeveloperAPIMyCloudQueueItems()
        if include_optional:
            return DeveloperAPIMyCloudQueueItems(
                id = '',
                name = '',
                volume_ml = 1.337,
                material_name = '',
    ...
    def testDeveloperAPIMyCloudQueueItems(self):
        """Test DeveloperAPIMyCloudQueueItems"""
