...
class TestRequestAnAccessToken200Response(unittest.TestCase):
    """RequestAnAccessToken200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestAnAccessToken200Response:
        """Test RequestAnAccessToken200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestAnAccessToken200Response`
        """
        model = RequestAnAccessToken200Response()
        if include_optional:
            return RequestAnAccessToken200Response(
                access_token = '',
                token_type = '',
                expires_in = 56,
                scope = ''
    ...
    def testRequestAnAccessToken200Response(self):
        """Test RequestAnAccessToken200Response"""
