...
class TestPaginatedTankList(unittest.TestCase):
    """PaginatedTankList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedTankList:
        """Test PaginatedTankList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedTankList`
        """
        model = PaginatedTankList()
        if include_optional:
            return PaginatedTankList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    formlabs_web_api.models.tank.Tank(
                        serial = '', 
                        material = '', 
    ...
    def testPaginatedTankList(self):
        """Test PaginatedTankList"""
