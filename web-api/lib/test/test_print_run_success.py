...
class TestPrintRunSuccess(unittest.TestCase):
    """PrintRunSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintRunSuccess:
        """Test PrintRunSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintRunSuccess`
        """
        model = PrintRunSuccess()
        if include_optional:
            return PrintRunSuccess(
                print_run = '',
