...
class TestPrintThumbnailSerializerOnlyThumbnail(unittest.TestCase):
    """PrintThumbnailSerializerOnlyThumbnail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintThumbnailSerializerOnlyThumbnail:
        """Test PrintThumbnailSerializerOnlyThumbnail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintThumbnailSerializerOnlyThumbnail`
        """
        model = PrintThumbnailSerializerOnlyThumbnail()
        if include_optional:
            return PrintThumbnailSerializerOnlyThumbnail(
                thumbnail = ''
            )
        else:
            return PrintThumbnailSerializerOnlyThumbnail(
    ...
    def testPrintThumbnailSerializerOnlyThumbnail(self):
        """Test PrintThumbnailSerializerOnlyThumbnail"""
