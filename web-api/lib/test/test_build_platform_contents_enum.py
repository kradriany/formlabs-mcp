...
class TestBuildPlatformContentsEnum(unittest.TestCase):
    """BuildPlatformContentsEnum unit test stubs"""
    ...
    def testBuildPlatformContentsEnum(self):
        """Test BuildPlatformContentsEnum"""
        # inst = BuildPlatformContentsEnum()
