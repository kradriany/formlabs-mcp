...
class TestPatchedPartialWorkGroupRequest(unittest.TestCase):
    """PatchedPartialWorkGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedPartialWorkGroupRequest:
        """Test PatchedPartialWorkGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedPartialWorkGroupRequest`
        """
        model = PatchedPartialWorkGroupRequest()
        if include_optional:
            return PatchedPartialWorkGroupRequest(
                name = '0',
                remote_print_enabled_override = '0'
            )
        else:
            return PatchedPartialWorkGroupRequest(
        )
    ...
    def testPatchedPartialWorkGroupRequest(self):
        """Test PatchedPartialWorkGroupRequest"""
