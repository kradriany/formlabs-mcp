...
class TestPartialWorkGroupRequest(unittest.TestCase):
    """PartialWorkGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialWorkGroupRequest:
        """Test PartialWorkGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartialWorkGroupRequest`
        """
        model = PartialWorkGroupRequest()
        if include_optional:
            return PartialWorkGroupRequest(
                name = '0'
            )
        else:
            return PartialWorkGroupRequest(
    ...
    def testPartialWorkGroupRequest(self):
        """Test PartialWorkGroupRequest"""
