...
class TestPrintPart(unittest.TestCase):
    """PrintPart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintPart:
        """Test PrintPart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintPart`
        """
        model = PrintPart()
        if include_optional:
            return PrintPart(
