...
class TestCartridgeSlotEnum(unittest.TestCase):
    """CartridgeSlotEnum unit test stubs"""
    ...
    def testCartridgeSlotEnum(self):
        """Test CartridgeSlotEnum"""
        # inst = CartridgeSlotEnum()
