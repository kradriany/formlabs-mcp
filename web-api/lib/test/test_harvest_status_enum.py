...
class TestHarvestStatusEnum(unittest.TestCase):
    """HarvestStatusEnum unit test stubs"""
    ...
    def testHarvestStatusEnum(self):
        """Test HarvestStatusEnum"""
        # inst = HarvestStatusEnum()
