...
class AuthenticationApi:
    ...
    @validate_call
    def request_an_access_token(
        self,
        grant_type: Annotated[StrictStr, Field(description="The type of grant being used. Currently only `client_credentials` is supported")],
        client_id: Annotated[StrictStr, Field(description="Your Client ID.")],
        client_secret: Annotated[StrictStr, Field(description="Your Client Secret.")],
        ...
        :param grant_type: The type of grant being used. Currently only `client_credentials` is supported (required)
        :type grant_type: str
        ...
        _param = self._request_an_access_token_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RequestAnAccessToken200Response",
            '400': "RequestAnAccessToken400Response",
            '401': "RequestAnAccessToken401Response",
        }
    ...
    @validate_call
    def request_an_access_token_with_http_info(
        self,
        grant_type: Annotated[StrictStr, Field(description="The type of grant being used. Currently only `client_credentials` is supported")],
        client_id: Annotated[StrictStr, Field(description="Your Client ID.")],
        client_secret: Annotated[StrictStr, Field(description="Your Client Secret.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RequestAnAccessToken200Response]:
        """request_an_access_token
    ...
    @validate_call
    def request_an_access_token_without_preload_content(
        self,
        grant_type: Annotated[StrictStr, Field(description="The type of grant being used. Currently only `client_credentials` is supported")],
        client_id: Annotated[StrictStr, Field(description="Your Client ID.")],
        client_secret: Annotated[StrictStr, Field(description="Your Client Secret.")],
    ...
    def _request_an_access_token_serialize(
        self,
        grant_type,
        client_id,
        client_secret,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/developer/v1/o/token/',
    ...
    def revoke_an_access_token(
        self,
        token: Annotated[StrictStr, Field(description="Your access token.")],
        client_id: Annotated[StrictStr, Field(description="Your client ID.")],
        client_secret: Annotated[StrictStr, Field(description="Your client secret.")],
        _request_timeout: Union[
            None,
    ...
    def _revoke_an_access_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/developer/v1/o/revoke_token/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
