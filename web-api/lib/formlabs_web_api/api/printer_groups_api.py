...
class PrinterGroupsApi:
    ...
    @validate_call
    def groups_bulk_add_printers_create(
        self,
        developer_api_groups_bulk_add_printers_request: DeveloperAPIGroupsBulkAddPrintersRequest,
        ...
        :param developer_api_groups_bulk_add_printers_request: (required)
        :type developer_api_groups_bulk_add_printers_request: DeveloperAPIGroupsBulkAddPrintersRequest
        ...
        _param = self._groups_bulk_add_printers_create_serialize(
            developer_api_groups_bulk_add_printers_request=developer_api_groups_bulk_add_printers_request,
    ...
    @validate_call
    def groups_bulk_add_printers_create_with_http_info(
        self,
        developer_api_groups_bulk_add_printers_request: DeveloperAPIGroupsBulkAddPrintersRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def groups_bulk_add_printers_create_without_preload_content(
        self,
        developer_api_groups_bulk_add_printers_request: DeveloperAPIGroupsBulkAddPrintersRequest,
        _request_timeout: Union[
            None,
    ...
    def _groups_bulk_add_printers_create_serialize(
        self,
        developer_api_groups_bulk_add_printers_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if developer_api_groups_bulk_add_printers_request is not None:
            _body_params = developer_api_groups_bulk_add_printers_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/developer/v1/groups/bulk-add-printers/',
    ...
    def groups_members_create(
        self,
        group_id: Annotated[StrictStr, Field(description="A UUID string identifying this Printer Group")],
        ...
        :param group_id: A UUID string identifying this Printer Group (required)
        :type group_id: str
    ...
    def groups_queue_list(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[DeveloperAPIMyCloudQueueItems]:
        """groups_queue_list
        ...
        _param = self._groups_queue_list_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[DeveloperAPIMyCloudQueueItems]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def groups_queue_list_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="A UUID string identifying this Printer Group")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DeveloperAPIMyCloudQueueItems]]:
        """groups_queue_list
    ...
    @validate_call
    def groups_queue_list_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="A UUID string identifying this Printer Group")],
        _request_timeout: Union[
            None,
    ...
    def _groups_queue_list_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/developer/v1/groups/{group_id}/queue/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
