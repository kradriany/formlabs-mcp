...
class WorkgroupSettings(BaseModel):
    ...
    """ # noqa: E501
    group: StrictStr
    update_mode: Optional[WorkgroupSettingsUpdateMode] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of update_mode
        if self.update_mode:
            _dict['update_mode'] = self.update_mode.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": obj.get("group"),
            "update_mode": WorkgroupSettingsUpdateMode.from_dict(obj["update_mode"]) if obj.get("update_mode") is not None else None
        })
        return _obj
