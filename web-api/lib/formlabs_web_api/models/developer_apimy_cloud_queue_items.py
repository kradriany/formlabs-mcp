...
class DeveloperAPIMyCloudQueueItems(BaseModel):
    """
    ...
    created_at: datetime
    username: StrictStr
    allowed_machine_type_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "volume_ml", "material_name", "created_at", "username", "allowed_machine_type_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowed_machine_type_ids": obj.get("allowed_machine_type_ids")
        })
        return _obj
