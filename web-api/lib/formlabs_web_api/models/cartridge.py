...
class Cartridge(BaseModel):
    ...
    consumable_type: Optional[StrictStr] = None
    machine_type_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["serial", "consumable_type", "machine_type_id", "material", "initial_volume_ml", "volume_dispensed_ml", "dispense_count", "write_count", "mechanical_version", "manufacture_date", "manufacturer", "display_name", "lot_number", "last_modified", "is_empty", "inside_printer", "connected_group", "created_at", "last_print_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consumable_type": obj.get("consumable_type"),
