...
class DeveloperAPIGroupsBulkAddPrintersRequest(BaseModel):
    """
    DeveloperAPIGroupsBulkAddPrintersRequest
    """ # noqa: E501
    target_group: StrictStr
    printers: List[Any]
    __properties: ClassVar[List[str]] = ["target_group", "printers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target_group": obj.get("target_group"),
