...
class PrintRunNote(BaseModel):
    """
    PrintRunNote
    """ # noqa: E501
    print_run: StrictStr
    note: StrictStr
    author: Optional[BasicUser] = None
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["print_run", "note", "author", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "print_run": obj.get("print_run"),
            "note": obj.get("note"),
            "author": BasicUser.from_dict(obj["author"]) if obj.get("author") is not None else None,
