...
class CartridgeReadOnly(BaseModel):
    """
    CartridgeReadOnly
    """ # noqa: E501
    serial: StrictStr
    material: Optional[StrictStr]
    consumable_type: StrictStr
    initial_volume_ml: Union[StrictFloat, StrictInt]
    volume_dispensed_ml: Union[StrictFloat, StrictInt]
    ...
    machine_type_id: StrictStr
    __properties: ClassVar[List[str]] = ["serial", "material", "consumable_type", "initial_volume_ml", "volume_dispensed_ml", "display_name", "is_empty", "inside_printer", "connected_group", "created_at", "last_print_date", "machine_type_id"]
