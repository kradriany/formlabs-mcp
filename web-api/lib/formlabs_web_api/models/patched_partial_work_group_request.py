...
class PatchedPartialWorkGroupRequest(BaseModel):
    """
    PatchedPartialWorkGroupRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    remote_print_enabled_override: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["name", "remote_print_enabled_override"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if remote_print_enabled_override (nullable) is None
        # and model_fields_set contains the field
        if self.remote_print_enabled_override is None and "remote_print_enabled_override" in self.model_fields_set:
            _dict['remote_print_enabled_override'] = None
