...
class TestForm4FamilyDeviceStatusModel(unittest.TestCase):
    """Form4FamilyDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Form4FamilyDeviceStatusModel:
        """Test Form4FamilyDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Form4FamilyDeviceStatusModel`
        """
        model = Form4FamilyDeviceStatusModel()
        if include_optional:
            return Form4FamilyDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testForm4FamilyDeviceStatusModel(self):
        """Test Form4FamilyDeviceStatusModel"""
