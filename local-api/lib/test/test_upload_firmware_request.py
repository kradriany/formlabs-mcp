...
class TestUploadFirmwareRequest(unittest.TestCase):
    """UploadFirmwareRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadFirmwareRequest:
        """Test UploadFirmwareRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadFirmwareRequest`
        """
        model = UploadFirmwareRequest()
        if include_optional:
    ...
    def testUploadFirmwareRequest(self):
        """Test UploadFirmwareRequest"""
