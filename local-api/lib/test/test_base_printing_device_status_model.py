...
class TestBasePrintingDeviceStatusModel(unittest.TestCase):
    """BasePrintingDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasePrintingDeviceStatusModel:
        """Test BasePrintingDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasePrintingDeviceStatusModel`
        """
        model = BasePrintingDeviceStatusModel()
        if include_optional:
            return BasePrintingDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testBasePrintingDeviceStatusModel(self):
        """Test BasePrintingDeviceStatusModel"""
