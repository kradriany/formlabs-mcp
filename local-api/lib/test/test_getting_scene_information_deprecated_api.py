...
class TestGettingSceneInformationDeprecatedApi(unittest.TestCase):
    """GettingSceneInformationDeprecatedApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GettingSceneInformationDeprecatedApi()

    def tearDown(self) -> None:
        pass

    def test_estimate_print_time_deprecated(self) -> None:
        """Test case for estimate_print_time_deprecated

        Estimate Print Time
        """
        pass

    def test_get_model_deprecated(self) -> None:
        """Test case for get_model_deprecated

        Get model
        """
        pass

    def test_get_print_validation_deprecated(self) -> None:
        """Test case for get_print_validation_deprecated

        Get Print Validation
        """
        pass

    def test_get_scene_deprecated(self) -> None:
        """Test case for get_scene_deprecated

        Get Scene
        """
        pass

    def test_get_scene_interferences_deprecated(self) -> None:
        """Test case for get_scene_interferences_deprecated
