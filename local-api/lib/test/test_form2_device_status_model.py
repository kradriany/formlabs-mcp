...
class TestForm2DeviceStatusModel(unittest.TestCase):
    """Form2DeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Form2DeviceStatusModel:
        """Test Form2DeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Form2DeviceStatusModel`
        """
        model = Form2DeviceStatusModel()
        if include_optional:
            return Form2DeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testForm2DeviceStatusModel(self):
        """Test Form2DeviceStatusModel"""
