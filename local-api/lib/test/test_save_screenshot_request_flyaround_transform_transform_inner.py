...
class TestSaveScreenshotRequestFlyaroundTransformTransformInner(unittest.TestCase):
    """SaveScreenshotRequestFlyaroundTransformTransformInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveScreenshotRequestFlyaroundTransformTransformInner:
        """Test SaveScreenshotRequestFlyaroundTransformTransformInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveScreenshotRequestFlyaroundTransformTransformInner`
        """
        model = SaveScreenshotRequestFlyaroundTransformTransformInner()
        if include_optional:
            return SaveScreenshotRequestFlyaroundTransformTransformInner(
                yaw = 1.337,
                pitch = 1.337
            )
        else:
    ...
    def testSaveScreenshotRequestFlyaroundTransformTransformInner(self):
        """Test SaveScreenshotRequestFlyaroundTransformTransformInner"""
