...
class TestUserInformationModel(unittest.TestCase):
    """UserInformationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserInformationModel:
        """Test UserInformationModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInformationModel`
        """
    ...
    def testUserInformationModel(self):
        """Test UserInformationModel"""
