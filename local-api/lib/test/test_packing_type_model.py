...
class TestPackingTypeModel(unittest.TestCase):
    """PackingTypeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackingTypeModel:
        """Test PackingTypeModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackingTypeModel`
        """
