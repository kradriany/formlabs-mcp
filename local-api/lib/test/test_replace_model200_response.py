...
class TestReplaceModel200Response(unittest.TestCase):
    """ReplaceModel200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceModel200Response:
        """Test ReplaceModel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceModel200Response`
        """
        model = ReplaceModel200Response()
        if include_optional:
            return ReplaceModel200Response(
                warnings = [
                    ''
                    ],
    ...
    def testReplaceModel200Response(self):
        """Test ReplaceModel200Response"""
