...
class TestHollowModelRequest(unittest.TestCase):
    """HollowModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HollowModelRequest:
        """Test HollowModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HollowModelRequest`
        """
        model = HollowModelRequest()
        if include_optional:
            return HollowModelRequest(
                models = None,
    ...
    def testHollowModelRequest(self):
        """Test HollowModelRequest"""
