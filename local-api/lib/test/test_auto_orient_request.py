...
class TestAutoOrientRequest(unittest.TestCase):
    """AutoOrientRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoOrientRequest:
        """Test AutoOrientRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoOrientRequest`
        """
        model = AutoOrientRequest()
        if include_optional:
            return AutoOrientRequest(
                models = None,
                mode = 'DENTAL',
                tilt = 56
            )
    ...
    def testAutoOrientRequest(self):
        """Test AutoOrientRequest"""
