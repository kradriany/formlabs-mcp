...
class TestFleetControlPrinterGroupDeviceStatusModelAllOfPrinters(unittest.TestCase):
    """FleetControlPrinterGroupDeviceStatusModelAllOfPrinters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FleetControlPrinterGroupDeviceStatusModelAllOfPrinters:
        """Test FleetControlPrinterGroupDeviceStatusModelAllOfPrinters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FleetControlPrinterGroupDeviceStatusModelAllOfPrinters`
        """
        model = FleetControlPrinterGroupDeviceStatusModelAllOfPrinters()
        if include_optional:
            return FleetControlPrinterGroupDeviceStatusModelAllOfPrinters(
                id = '',
                machine_type_id = ''
            )
        else:
    ...
    def testFleetControlPrinterGroupDeviceStatusModelAllOfPrinters(self):
        """Test FleetControlPrinterGroupDeviceStatusModelAllOfPrinters"""
