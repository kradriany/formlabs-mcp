...
class TestListMaterials200ResponsePrinterTypesInner(unittest.TestCase):
    """ListMaterials200ResponsePrinterTypesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMaterials200ResponsePrinterTypesInner:
        """Test ListMaterials200ResponsePrinterTypesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMaterials200ResponsePrinterTypesInner`
        """
        model = ListMaterials200ResponsePrinterTypesInner()
        if include_optional:
            return ListMaterials200ResponsePrinterTypesInner(
                label = '',
                materials = [
                    formlabs_local_api.models.list_materials_200_response_printer_types_inner_materials_inner.listMaterials_200_response_printer_types_inner_materials_inner(
                        label = '', 
                        material_settings = [
    ...
    def testListMaterials200ResponsePrinterTypesInner(self):
        """Test ListMaterials200ResponsePrinterTypesInner"""
