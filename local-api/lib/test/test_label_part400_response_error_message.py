...
class TestLabelPart400ResponseErrorMessage(unittest.TestCase):
    """LabelPart400ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelPart400ResponseErrorMessage:
        """Test LabelPart400ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelPart400ResponseErrorMessage`
        """
        model = LabelPart400ResponseErrorMessage()
        if include_optional:
            return LabelPart400ResponseErrorMessage(
            )
        else:
            return LabelPart400ResponseErrorMessage(
        )
    ...
    def testLabelPart400ResponseErrorMessage(self):
        """Test LabelPart400ResponseErrorMessage"""
