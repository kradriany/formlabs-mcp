...
class TestDrainHoleModel(unittest.TestCase):
    """DrainHoleModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrainHoleModel:
        """Test DrainHoleModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrainHoleModel`
        """
        model = DrainHoleModel()
        if include_optional:
            return DrainHoleModel(
