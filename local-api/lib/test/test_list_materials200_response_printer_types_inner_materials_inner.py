...
class TestListMaterials200ResponsePrinterTypesInnerMaterialsInner(unittest.TestCase):
    """ListMaterials200ResponsePrinterTypesInnerMaterialsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMaterials200ResponsePrinterTypesInnerMaterialsInner:
        """Test ListMaterials200ResponsePrinterTypesInnerMaterialsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMaterials200ResponsePrinterTypesInnerMaterialsInner`
        """
        model = ListMaterials200ResponsePrinterTypesInnerMaterialsInner()
        if include_optional:
            return ListMaterials200ResponsePrinterTypesInnerMaterialsInner(
                label = '',
                material_settings = [
    ...
    def testListMaterials200ResponsePrinterTypesInnerMaterialsInner(self):
        """Test ListMaterials200ResponsePrinterTypesInnerMaterialsInner"""
