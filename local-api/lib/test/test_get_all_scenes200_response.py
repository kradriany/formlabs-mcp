...
class TestGetAllScenes200Response(unittest.TestCase):
    """GetAllScenes200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllScenes200Response:
        """Test GetAllScenes200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllScenes200Response`
        """
        model = GetAllScenes200Response()
        if include_optional:
            return GetAllScenes200Response(
                scenes = [
                    formlabs_local_api.models.scene_model.SceneModel(
                        models = [
                            formlabs_local_api.models.model_properties.ModelProperties(
                                id = '', 
                                name = '', 
    ...
    def testGetAllScenes200Response(self):
        """Test GetAllScenes200Response"""
