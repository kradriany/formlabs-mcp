...
class TestExportingDeprecatedApi(unittest.TestCase):
    """ExportingDeprecatedApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExportingDeprecatedApi()

    def tearDown(self) -> None:
        pass

    def test_save_form_file_deprecated(self) -> None:
        """Test case for save_form_file_deprecated

        Save .form file
        """
        pass

    def test_save_fps_file_deprecated(self) -> None:
        """Test case for save_fps_file_deprecated

        Save FPS file
        """
        pass

    def test_save_screenshot_deprecated(self) -> None:
        """Test case for save_screenshot_deprecated
