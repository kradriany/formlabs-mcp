...
class TestDiscoverDevicesRequest(unittest.TestCase):
    """DiscoverDevicesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscoverDevicesRequest:
        """Test DiscoverDevicesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoverDevicesRequest`
        """
        model = DiscoverDevicesRequest()
        if include_optional:
    ...
    def testDiscoverDevicesRequest(self):
        """Test DiscoverDevicesRequest"""
