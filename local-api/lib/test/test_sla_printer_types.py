...
class TestSLAPrinterTypes(unittest.TestCase):
    """SLAPrinterTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SLAPrinterTypes:
        """Test SLAPrinterTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SLAPrinterTypes`
        """
        model = SLAPrinterTypes()
        if include_optional:
            return SLAPrinterTypes(
