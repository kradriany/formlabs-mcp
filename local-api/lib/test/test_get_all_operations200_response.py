...
class TestGetAllOperations200Response(unittest.TestCase):
    """GetAllOperations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllOperations200Response:
        """Test GetAllOperations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllOperations200Response`
        """
        model = GetAllOperations200Response()
        if include_optional:
            return GetAllOperations200Response(
                count = 56,
                operations = [
                    formlabs_local_api.models.get_all_operations_200_response_operations_inner.getAllOperations_200_response_operations_inner(
                        id = '', 
                        status = 'IN_PROGRESS', 
                        progress = 1.337, )
                    ]
    ...
    def testGetAllOperations200Response(self):
        """Test GetAllOperations200Response"""
