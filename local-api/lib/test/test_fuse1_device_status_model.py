...
class TestFuse1DeviceStatusModel(unittest.TestCase):
    """Fuse1DeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Fuse1DeviceStatusModel:
        """Test Fuse1DeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Fuse1DeviceStatusModel`
        """
        model = Fuse1DeviceStatusModel()
        if include_optional:
            return Fuse1DeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testFuse1DeviceStatusModel(self):
        """Test Fuse1DeviceStatusModel"""
