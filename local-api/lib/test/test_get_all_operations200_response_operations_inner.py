...
class TestGetAllOperations200ResponseOperationsInner(unittest.TestCase):
    """GetAllOperations200ResponseOperationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllOperations200ResponseOperationsInner:
        """Test GetAllOperations200ResponseOperationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllOperations200ResponseOperationsInner`
        """
        model = GetAllOperations200ResponseOperationsInner()
        if include_optional:
            return GetAllOperations200ResponseOperationsInner(
                id = '',
                status = 'IN_PROGRESS',
                progress = 1.337
            )
    ...
    def testGetAllOperations200ResponseOperationsInner(self):
        """Test GetAllOperations200ResponseOperationsInner"""
