...
class TestUsernameAndPassword(unittest.TestCase):
    """UsernameAndPassword unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsernameAndPassword:
        """Test UsernameAndPassword
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsernameAndPassword`
        """
        model = UsernameAndPassword()
        if include_optional:
    ...
    def testUsernameAndPassword(self):
        """Test UsernameAndPassword"""
