...
class TestAutoLayoutRequestCustomBounds(unittest.TestCase):
    """AutoLayoutRequestCustomBounds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoLayoutRequestCustomBounds:
        """Test AutoLayoutRequestCustomBounds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoLayoutRequestCustomBounds`
        """
        model = AutoLayoutRequestCustomBounds()
        if include_optional:
            return AutoLayoutRequestCustomBounds(
                x_min_mm = 1.337,
                x_max_mm = 1.337,
                y_min_mm = 1.337,
                y_max_mm = 1.337
    ...
    def testAutoLayoutRequestCustomBounds(self):
        """Test AutoLayoutRequestCustomBounds"""
