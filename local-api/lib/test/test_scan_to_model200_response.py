...
class TestScanToModel200Response(unittest.TestCase):
    """ScanToModel200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScanToModel200Response:
        """Test ScanToModel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScanToModel200Response`
        """
        model = ScanToModel200Response()
        if include_optional:
            return ScanToModel200Response(
                models = [
    ...
    def testScanToModel200Response(self):
        """Test ScanToModel200Response"""
