...
class TestListMaterials200Response(unittest.TestCase):
    """ListMaterials200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMaterials200Response:
        """Test ListMaterials200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMaterials200Response`
        """
        model = ListMaterials200Response()
        if include_optional:
            return ListMaterials200Response(
                printer_types = [
                    formlabs_local_api.models.list_materials_200_response_printer_types_inner.listMaterials_200_response_printer_types_inner(
                        label = '', 
    ...
    def testListMaterials200Response(self):
        """Test ListMaterials200Response"""
