...
class TestBaseDeviceStatusModel(unittest.TestCase):
    """BaseDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseDeviceStatusModel:
        """Test BaseDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseDeviceStatusModel`
        """
        model = BaseDeviceStatusModel()
        if include_optional:
            return BaseDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testBaseDeviceStatusModel(self):
        """Test BaseDeviceStatusModel"""
