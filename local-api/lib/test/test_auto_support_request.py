...
class TestAutoSupportRequest(unittest.TestCase):
    """AutoSupportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoSupportRequest:
        """Test AutoSupportRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoSupportRequest`
        """
        model = AutoSupportRequest()
        if include_optional:
            return AutoSupportRequest(
                models = None,
                density = 0,
                slope_multiplier = 0,
                only_minima = True,
    ...
    def testAutoSupportRequest(self):
        """Test AutoSupportRequest"""
