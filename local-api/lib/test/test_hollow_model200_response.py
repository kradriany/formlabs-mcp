...
class TestHollowModel200Response(unittest.TestCase):
    """HollowModel200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HollowModel200Response:
        """Test HollowModel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HollowModel200Response`
        """
        model = HollowModel200Response()
        if include_optional:
            return HollowModel200Response(
                warnings = [
                    ''
                    ],
                infos = [
    ...
    def testHollowModel200Response(self):
        """Test HollowModel200Response"""
