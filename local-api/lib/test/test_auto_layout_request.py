...
class TestAutoLayoutRequest(unittest.TestCase):
    """AutoLayoutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoLayoutRequest:
        """Test AutoLayoutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoLayoutRequest`
        """
        model = AutoLayoutRequest()
        if include_optional:
            return AutoLayoutRequest(
                models = None,
                mode = 'DENTAL',
                model_spacing_mm = 0,
                allow_overlapping_supports = True,
                lock_rotation = True,
                build_platform_2_optimized = True,
                custom_bounds = formlabs_local_api.models.auto_layout_request_custom_bounds.autoLayout_request_custom_bounds(
                    x_min_mm = 1.337, 
                    x_max_mm = 1.337, 
                    y_min_mm = 1.337, 
                    y_max_mm = 1.337, )
    ...
    def testAutoLayoutRequest(self):
        """Test AutoLayoutRequest"""
