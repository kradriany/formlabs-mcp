...
class TestAutoPackRequest(unittest.TestCase):
    """AutoPackRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoPackRequest:
        """Test AutoPackRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoPackRequest`
        """
        model = AutoPackRequest()
        if include_optional:
            return AutoPackRequest(
                model_spacing_mm = 0
            )
        else:
            return AutoPackRequest(
