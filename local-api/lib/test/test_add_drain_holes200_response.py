...
class TestAddDrainHoles200Response(unittest.TestCase):
    """AddDrainHoles200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddDrainHoles200Response:
        """Test AddDrainHoles200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDrainHoles200Response`
        """
        model = AddDrainHoles200Response()
        if include_optional:
            return AddDrainHoles200Response(
                plugs = None,
                warnings = [
                    ''
                    ],
    ...
    def testAddDrainHoles200Response(self):
        """Test AddDrainHoles200Response"""
