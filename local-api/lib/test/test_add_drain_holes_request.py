...
class TestAddDrainHolesRequest(unittest.TestCase):
    """AddDrainHolesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddDrainHolesRequest:
        """Test AddDrainHolesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDrainHolesRequest`
        """
        model = AddDrainHolesRequest()
        if include_optional:
            return AddDrainHolesRequest(
                model_id = '',
                drain_holes = [
                    formlabs_local_api.models.drain_hole_model.DrainHoleModel(
    ...
    def testAddDrainHolesRequest(self):
        """Test AddDrainHolesRequest"""
