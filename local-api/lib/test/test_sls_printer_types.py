...
class TestSLSPrinterTypes(unittest.TestCase):
    """SLSPrinterTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SLSPrinterTypes:
        """Test SLSPrinterTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SLSPrinterTypes`
        """
        model = SLSPrinterTypes()
        if include_optional:
            return SLSPrinterTypes(
                total_print_time_s = 1.337,
                preprint_time_s = 1.337,
                printing_time_s = 1.337,
                cool_to_removal_time_s = 1.337,
                additional_cool_to_room_temp_time_s = 1.337
            )
        else:
            return SLSPrinterTypes(
        )
