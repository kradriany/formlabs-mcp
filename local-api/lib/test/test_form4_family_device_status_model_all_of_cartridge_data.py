...
class TestForm4FamilyDeviceStatusModelAllOfCartridgeData(unittest.TestCase):
    """Form4FamilyDeviceStatusModelAllOfCartridgeData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Form4FamilyDeviceStatusModelAllOfCartridgeData:
        """Test Form4FamilyDeviceStatusModelAllOfCartridgeData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Form4FamilyDeviceStatusModelAllOfCartridgeData`
        """
        model = Form4FamilyDeviceStatusModelAllOfCartridgeData()
        if include_optional:
            return Form4FamilyDeviceStatusModelAllOfCartridgeData(
    ...
    def testForm4FamilyDeviceStatusModelAllOfCartridgeData(self):
        """Test Form4FamilyDeviceStatusModelAllOfCartridgeData"""
