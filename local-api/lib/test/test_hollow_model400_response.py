...
class TestHollowModel400Response(unittest.TestCase):
    """HollowModel400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HollowModel400Response:
        """Test HollowModel400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HollowModel400Response`
        """
        model = HollowModel400Response()
        if include_optional:
            return HollowModel400Response(
                failures = [
                    ''
                    ]
            )
    ...
    def testHollowModel400Response(self):
        """Test HollowModel400Response"""
