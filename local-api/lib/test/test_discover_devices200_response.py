...
class TestDiscoverDevices200Response(unittest.TestCase):
    """DiscoverDevices200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscoverDevices200Response:
        """Test DiscoverDevices200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoverDevices200Response`
        """
        model = DiscoverDevices200Response()
        if include_optional:
            return DiscoverDevices200Response(
                count = 56,
                devices = [
    ...
    def testDiscoverDevices200Response(self):
        """Test DiscoverDevices200Response"""
