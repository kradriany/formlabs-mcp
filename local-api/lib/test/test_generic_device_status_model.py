...
class TestGenericDeviceStatusModel(unittest.TestCase):
    """GenericDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenericDeviceStatusModel:
        """Test GenericDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericDeviceStatusModel`
        """
        model = GenericDeviceStatusModel()
        if include_optional:
            return GenericDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
    ...
    def testGenericDeviceStatusModel(self):
        """Test GenericDeviceStatusModel"""
