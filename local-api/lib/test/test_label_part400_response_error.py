...
class TestLabelPart400ResponseError(unittest.TestCase):
    """LabelPart400ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelPart400ResponseError:
        """Test LabelPart400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelPart400ResponseError`
        """
        model = LabelPart400ResponseError()
        if include_optional:
            return LabelPart400ResponseError(
                message = None
            )
        else:
            return LabelPart400ResponseError(
    ...
    def testLabelPart400ResponseError(self):
        """Test LabelPart400ResponseError"""
