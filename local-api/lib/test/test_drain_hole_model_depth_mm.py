...
class TestDrainHoleModelDepthMm(unittest.TestCase):
    """DrainHoleModelDepthMm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrainHoleModelDepthMm:
        """Test DrainHoleModelDepthMm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrainHoleModelDepthMm`
        """
        model = DrainHoleModelDepthMm()
        if include_optional:
            return DrainHoleModelDepthMm(
            )
        else:
            return DrainHoleModelDepthMm(
        )
    ...
    def testDrainHoleModelDepthMm(self):
        """Test DrainHoleModelDepthMm"""
