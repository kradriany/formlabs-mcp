...
class TestLabelPartRequest(unittest.TestCase):
    """LabelPartRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelPartRequest:
        """Test LabelPartRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelPartRequest`
        """
        model = LabelPartRequest()
        if include_optional:
            return LabelPartRequest(
                model_id = '',
