...
class TestLoadFormFileRequest(unittest.TestCase):
    """LoadFormFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoadFormFileRequest:
        """Test LoadFormFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoadFormFileRequest`
        """
        model = LoadFormFileRequest()
        if include_optional:
            return LoadFormFileRequest(
                file = ''
            )
        else:
            return LoadFormFileRequest(
    ...
    def testLoadFormFileRequest(self):
        """Test LoadFormFileRequest"""
