...
class TestOperationAcceptedModel(unittest.TestCase):
    """OperationAcceptedModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationAcceptedModel:
        """Test OperationAcceptedModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationAcceptedModel`
        """
        model = OperationAcceptedModel()
        if include_optional:
            return OperationAcceptedModel(
                operation_id = ''
            )
        else:
            return OperationAcceptedModel(
    ...
    def testOperationAcceptedModel(self):
        """Test OperationAcceptedModel"""
