...
class TestSaveScreenshotRequestFlyaroundTransform(unittest.TestCase):
    """SaveScreenshotRequestFlyaroundTransform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveScreenshotRequestFlyaroundTransform:
        """Test SaveScreenshotRequestFlyaroundTransform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveScreenshotRequestFlyaroundTransform`
        """
        model = SaveScreenshotRequestFlyaroundTransform()
        if include_optional:
            return SaveScreenshotRequestFlyaroundTransform(
                transform = [
                    formlabs_local_api.models.save_screenshot_request_flyaround_transform_transform_inner.saveScreenshot_request_flyaround_transform_transform_inner(
                        yaw = 1.337, 
                        pitch = 1.337, )
                    ],
                frame_count = 1.337,
                ensure_constant_size = True
            )
        else:
            return SaveScreenshotRequestFlyaroundTransform(
        )
    ...
    def testSaveScreenshotRequestFlyaroundTransform(self):
        """Test SaveScreenshotRequestFlyaroundTransform"""
