...
class TestWebAuthTokensModel(unittest.TestCase):
    """WebAuthTokensModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebAuthTokensModel:
        """Test WebAuthTokensModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebAuthTokensModel`
        """
        model = WebAuthTokensModel()
        if include_optional:
            return WebAuthTokensModel(
                access_token = '',
                refresh_token = ''
            )
        else:
    ...
    def testWebAuthTokensModel(self):
        """Test WebAuthTokensModel"""
