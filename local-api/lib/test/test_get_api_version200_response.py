...
class TestGetApiVersion200Response(unittest.TestCase):
    """GetApiVersion200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApiVersion200Response:
        """Test GetApiVersion200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApiVersion200Response`
        """
        model = GetApiVersion200Response()
        if include_optional:
    ...
    def testGetApiVersion200Response(self):
        """Test GetApiVersion200Response"""
