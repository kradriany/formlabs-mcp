...
class TestSaveScreenshotRequest(unittest.TestCase):
    """SaveScreenshotRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveScreenshotRequest:
        """Test SaveScreenshotRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveScreenshotRequest`
        """
        model = SaveScreenshotRequest()
        if include_optional:
            return SaveScreenshotRequest(
                ...
                crop_to_models = True,
                models = None,
                flyaround_transform = formlabs_local_api.models.save_screenshot_request_flyaround_transform.saveScreenshot_request_flyaround_transform(
                    transform = [
    ...
    def testSaveScreenshotRequest(self):
        """Test SaveScreenshotRequest"""
