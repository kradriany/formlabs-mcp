...
class TestForm3FamilyDeviceStatusModel(unittest.TestCase):
    """Form3FamilyDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Form3FamilyDeviceStatusModel:
        """Test Form3FamilyDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Form3FamilyDeviceStatusModel`
        """
        model = Form3FamilyDeviceStatusModel()
        if include_optional:
            return Form3FamilyDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
                ...
                tank_material_code = '',
                cartridge_data = {
                    'key' : formlabs_local_api.models.form4_family_device_status_model_all_of_cartridge_data.Form4FamilyDeviceStatusModel_allOf_cartridge_data(
    ...
    def testForm3FamilyDeviceStatusModel(self):
        """Test Form3FamilyDeviceStatusModel"""
