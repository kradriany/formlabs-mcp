...
class TestPrint200Response(unittest.TestCase):
    """Print200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Print200Response:
        """Test Print200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Print200Response`
        """
        model = Print200Response()
        if include_optional:
            return Print200Response(
                job_id = ''
            )
        else:
            return Print200Response(
