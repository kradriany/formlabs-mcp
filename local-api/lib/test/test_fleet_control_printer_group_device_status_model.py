...
class TestFleetControlPrinterGroupDeviceStatusModel(unittest.TestCase):
    """FleetControlPrinterGroupDeviceStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FleetControlPrinterGroupDeviceStatusModel:
        """Test FleetControlPrinterGroupDeviceStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FleetControlPrinterGroupDeviceStatusModel`
        """
        model = FleetControlPrinterGroupDeviceStatusModel()
        if include_optional:
            return FleetControlPrinterGroupDeviceStatusModel(
                id = '',
                product_name = '',
                status = '',
                is_connected = True,
                ...
                printers = [
                    formlabs_local_api.models.fleet_control_printer_group_device_status_model_all_of_printers.FleetControlPrinterGroupDeviceStatusModel_allOf_printers(
                        id = '', 
                        machine_type_id = '', )
                    ]
            )
    ...
    def testFleetControlPrinterGroupDeviceStatusModel(self):
        """Test FleetControlPrinterGroupDeviceStatusModel"""
