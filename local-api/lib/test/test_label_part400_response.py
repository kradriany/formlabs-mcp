...
class TestLabelPart400Response(unittest.TestCase):
    """LabelPart400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelPart400Response:
        """Test LabelPart400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelPart400Response`
        """
        model = LabelPart400Response()
        if include_optional:
            return LabelPart400Response(
                error = formlabs_local_api.models.label_part_400_response_error.labelPart_400_response_error(
                    message = null, )
            )
        else:
            return LabelPart400Response(
    ...
    def testLabelPart400Response(self):
        """Test LabelPart400Response"""
