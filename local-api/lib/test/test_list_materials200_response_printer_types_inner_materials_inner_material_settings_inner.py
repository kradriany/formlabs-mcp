...
class TestListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner(unittest.TestCase):
    """ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner:
        """Test ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner`
        """
        model = ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner()
        if include_optional:
    ...
    def testListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner(self):
        """Test ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner"""
