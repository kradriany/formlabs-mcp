...
class TestGetOperation200Response(unittest.TestCase):
    """GetOperation200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOperation200Response:
        """Test GetOperation200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOperation200Response`
        """
        model = GetOperation200Response()
        if include_optional:
            return GetOperation200Response(
                id = '',
                status = 'IN_PROGRESS',
                progress = 1.337,
                result = None
    ...
    def testGetOperation200Response(self):
        """Test GetOperation200Response"""
