...
class TestModifyingASceneApi(unittest.TestCase):
    ...
    def test_add_drain_holes(self) -> None:
        """Test case for add_drain_holes
    ...
    def test_auto_layout(self) -> None:
        """Test case for auto_layout

        Auto Layout
        """
        pass

    def test_auto_orient(self) -> None:
        """Test case for auto_orient

        Auto Orient
        """
        pass

    def test_auto_pack(self) -> None:
        """Test case for auto_pack

        Auto Pack
        """
        pass

    def test_auto_support(self) -> None:
        """Test case for auto_support

        Auto Support
        """
        pass

    def test_create_default_scene(self) -> None:
        """Test case for create_default_scene
    ...
    def test_duplicate_model(self) -> None:
        """Test case for duplicate_model

        Duplicate model
        """
        pass

    def test_hollow_model(self) -> None:
        """Test case for hollow_model
    ...
    def test_label_part(self) -> None:
        """Test case for label_part

        Label Part
        """
        pass

    def test_load_form_file(self) -> None:
        """Test case for load_form_file

        Load .form file
        """
        pass

    def test_pack_and_cage(self) -> None:
        """Test case for pack_and_cage
    ...
    def test_replace_model(self) -> None:
        """Test case for replace_model

        Replace model
        """
        pass

    def test_scan_to_model(self) -> None:
        """Test case for scan_to_model
