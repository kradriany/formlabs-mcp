...
class TestPackAndCageRequest(unittest.TestCase):
    """PackAndCageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackAndCageRequest:
        """Test PackAndCageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackAndCageRequest`
        """
        model = PackAndCageRequest()
        if include_optional:
            return PackAndCageRequest(
                models = None,
                packing_type = formlabs_local_api.models.packing_type_model.PackingTypeModel(
                    packing_type = 'PACK_VOLUME', ),
                cage_label = '',
    ...
    def testPackAndCageRequest(self):
        """Test PackAndCageRequest"""
