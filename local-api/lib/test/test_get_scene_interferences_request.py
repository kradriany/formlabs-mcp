...
class TestGetSceneInterferencesRequest(unittest.TestCase):
    """GetSceneInterferencesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSceneInterferencesRequest:
        """Test GetSceneInterferencesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSceneInterferencesRequest`
        """
        model = GetSceneInterferencesRequest()
        if include_optional:
            return GetSceneInterferencesRequest(
    ...
    def testGetSceneInterferencesRequest(self):
        """Test GetSceneInterferencesRequest"""
