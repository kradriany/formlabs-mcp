...
class TestModelsSelectionModel(unittest.TestCase):
    """ModelsSelectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsSelectionModel:
        """Test ModelsSelectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsSelectionModel`
        """
        model = ModelsSelectionModel()
        if include_optional:
            return ModelsSelectionModel(
            )
        else:
            return ModelsSelectionModel(
        )
    ...
    def testModelsSelectionModel(self):
        """Test ModelsSelectionModel"""
