...
class TestReplaceModelRequest(unittest.TestCase):
    """ReplaceModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceModelRequest:
        """Test ReplaceModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceModelRequest`
        """
        model = ReplaceModelRequest()
        if include_optional:
            return ReplaceModelRequest(
                file = '',
    ...
    def testReplaceModelRequest(self):
        """Test ReplaceModelRequest"""
