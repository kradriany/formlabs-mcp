...
class LockModel(str, Enum):
    ...
    """
    FREE = 'FREE'
    LOCKED_XY_ROTATION_FREE_TRANSLATION = 'LOCKED_XY_ROTATION_FREE_TRANSLATION'
    LOCKED_ROTATION_FREE_TRANSLATION = 'LOCKED_ROTATION_FREE_TRANSLATION'
    FULLY_LOCKED = 'FULLY_LOCKED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LockModel from a JSON string"""
