...
class ScanToModel200Response(BaseModel):
    """
    ScanToModel200Response
    """ # noqa: E501
    models: Optional[List[ModelProperties]] = None
    scene_settings: Optional[SceneTypeModel] = None
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the created scene")
    warnings: Optional[List[StrictStr]] = None
    infos: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["models", "scene_settings", "material_usage", "layer_count", "id", "warnings", "infos"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.models:
            ...
            _dict['models'] = _items
        # override the default output from pydantic by calling `to_dict()` of scene_settings
        if self.scene_settings:
            _dict['scene_settings'] = self.scene_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scene_settings": SceneTypeModel.from_dict(obj["scene_settings"]) if obj.get("scene_settings") is not None else None,
