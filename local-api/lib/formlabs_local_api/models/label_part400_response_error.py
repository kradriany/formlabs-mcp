...
class LabelPart400ResponseError(BaseModel):
    """
    LabelPart400ResponseError
    """ # noqa: E501
    message: Optional[LabelPart400ResponseErrorMessage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": LabelPart400ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
