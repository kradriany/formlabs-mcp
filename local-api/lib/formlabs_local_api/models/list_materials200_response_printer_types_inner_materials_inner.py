...
class ListMaterials200ResponsePrinterTypesInnerMaterialsInner(BaseModel):
    """
    ListMaterials200ResponsePrinterTypesInnerMaterialsInner
    """ # noqa: E501
    label: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    material_settings: Optional[List[ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner]] = None
    __properties: ClassVar[List[str]] = ["label", "description", "material_settings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in material_settings (list)
        _items = []
        if self.material_settings:
            for _item_material_settings in self.material_settings:
                if _item_material_settings:
                    _items.append(_item_material_settings.to_dict())
            _dict['material_settings'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "material_settings": [ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner.from_dict(_item) for _item in obj["material_settings"]] if obj.get("material_settings") is not None else None
        })
        return _obj
