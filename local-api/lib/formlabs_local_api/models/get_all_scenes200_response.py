...
class GetAllScenes200Response(BaseModel):
    """
    GetAllScenes200Response
    """ # noqa: E501
    scenes: Optional[List[SceneModel]] = None
    __properties: ClassVar[List[str]] = ["scenes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scenes": [SceneModel.from_dict(_item) for _item in obj["scenes"]] if obj.get("scenes") is not None else None
        })
        return _obj
