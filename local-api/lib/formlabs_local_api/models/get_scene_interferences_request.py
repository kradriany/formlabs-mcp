...
class GetSceneInterferencesRequest(BaseModel):
    """
    GetSceneInterferencesRequest
    """ # noqa: E501
    collision_offset_mm: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="The minimum distance between models for them not to be considered interfering with each other.")
    __properties: ClassVar[List[str]] = ["collision_offset_mm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collision_offset_mm": obj.get("collision_offset_mm")
        })
        return _obj
