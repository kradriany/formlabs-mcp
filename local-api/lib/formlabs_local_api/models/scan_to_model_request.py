...
class ScanToModelRequest(BaseModel):
    ...
    cutoff_height_mm: Union[StrictFloat, StrictInt] = Field(description="Remove all scan data below this height (in mm) from the model, replace with extrude from the bottom of the model.")
    ...
    cutoff_below_gumline_mm: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Remove all scan data below this height (in mm) from the model, relative to the gumline, replace with extrude from the bottom of the model.")
    shell_thickness_mm: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The thickness of the outer shell of the model, in mm. Requires hollow=true.")
    wall_thickness_mm: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The thickness of the honeycomb infill of the model, in mm. Requires hollow=true.")
    drain_hole_radius_mm: Optional[Union[StrictFloat, StrictInt]] = Field(default=1.5, description="The radius of drain holes in the model, in mm. Requires hollow=true.")
    drain_hole_height_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=1, description="The ratio of the height of the drain hole to the width of the drain hole. Requires hollow=true.")
    __properties: ClassVar[List[str]] = ["file", "units", "cutoff_height_mm", "extrude_distance_mm", "hollow", "cutoff_below_gumline_mm", "shell_thickness_mm", "wall_thickness_mm", "drain_hole_radius_mm", "drain_hole_height_ratio"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cutoff_below_gumline_mm": obj.get("cutoff_below_gumline_mm"),
            "shell_thickness_mm": obj.get("shell_thickness_mm"),
            "wall_thickness_mm": obj.get("wall_thickness_mm"),
            "drain_hole_radius_mm": obj.get("drain_hole_radius_mm") if obj.get("drain_hole_radius_mm") is not None else 1.5,
            "drain_hole_height_ratio": obj.get("drain_hole_height_ratio") if obj.get("drain_hole_height_ratio") is not None else 1
        })
        return _obj
