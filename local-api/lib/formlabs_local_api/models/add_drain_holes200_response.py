...
class AddDrainHoles200Response(BaseModel):
    """
    AddDrainHoles200Response
    """ # noqa: E501
    plugs: Optional[ModelsSelectionModel] = None
    warnings: Optional[List[StrictStr]] = None
    infos: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["plugs", "warnings", "infos"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of plugs
        if self.plugs:
            _dict['plugs'] = self.plugs.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugs": ModelsSelectionModel.from_dict(obj["plugs"]) if obj.get("plugs") is not None else None,
