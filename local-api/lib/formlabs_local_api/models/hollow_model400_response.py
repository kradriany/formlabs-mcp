...
class HollowModel400Response(BaseModel):
    """
    HollowModel400Response
    """ # noqa: E501
    failures: Optional[List[StrictStr]] = Field(default=None, description="The IDs of models the hollowing operation failed for")
