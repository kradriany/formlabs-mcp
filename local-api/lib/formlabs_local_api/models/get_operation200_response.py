...
class GetOperation200Response(BaseModel):
    """
    ...
    result: Optional[Dict[str, Any]] = Field(default=None, description="Result of the operation, if succeeded or failed. Matches the schema of the operation or its error response.")
    __properties: ClassVar[List[str]] = ["id", "status", "progress", "result"]
