...
class OperationAcceptedModel(BaseModel):
    """
    ...
    """ # noqa: E501
    operation_id: Optional[StrictStr] = Field(default=None, description="Randomly-generated UUID for this operation", alias="operationId")
