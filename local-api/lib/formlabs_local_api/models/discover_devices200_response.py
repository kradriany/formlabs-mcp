...
class DiscoverDevices200Response(BaseModel):
    """
    DiscoverDevices200Response
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of newly discovered devices")
    devices: Optional[List[DeviceStatusModel]] = None
    __properties: ClassVar[List[str]] = ["count", "devices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "devices": [DeviceStatusModel.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
