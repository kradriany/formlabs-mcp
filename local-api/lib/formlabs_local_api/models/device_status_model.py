...
DEVICESTATUSMODEL_ONE_OF_SCHEMAS = ["FleetControlPrinterGroupDeviceStatusModel", "Form2DeviceStatusModel", "Form3FamilyDeviceStatusModel", "Form4FamilyDeviceStatusModel", "Fuse1DeviceStatusModel", "GenericDeviceStatusModel"]

class DeviceStatusModel(BaseModel):
    """
    DeviceStatusModel
    """
    # data type: GenericDeviceStatusModel
    oneof_schema_1_validator: Optional[GenericDeviceStatusModel] = None
    # data type: FleetControlPrinterGroupDeviceStatusModel
    oneof_schema_2_validator: Optional[FleetControlPrinterGroupDeviceStatusModel] = None
    # data type: Form4FamilyDeviceStatusModel
    oneof_schema_3_validator: Optional[Form4FamilyDeviceStatusModel] = None
    # data type: Form3FamilyDeviceStatusModel
    oneof_schema_4_validator: Optional[Form3FamilyDeviceStatusModel] = None
    # data type: Fuse1DeviceStatusModel
    oneof_schema_5_validator: Optional[Fuse1DeviceStatusModel] = None
    # data type: Form2DeviceStatusModel
    oneof_schema_6_validator: Optional[Form2DeviceStatusModel] = None
    actual_instance: Optional[Union[FleetControlPrinterGroupDeviceStatusModel, Form2DeviceStatusModel, Form3FamilyDeviceStatusModel, Form4FamilyDeviceStatusModel, Fuse1DeviceStatusModel, GenericDeviceStatusModel]] = None
    one_of_schemas: Set[str] = { "FleetControlPrinterGroupDeviceStatusModel", "Form2DeviceStatusModel", "Form3FamilyDeviceStatusModel", "Form4FamilyDeviceStatusModel", "Fuse1DeviceStatusModel", "GenericDeviceStatusModel" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        error_messages = []
        match = 0
        # validate data type: GenericDeviceStatusModel
        if not isinstance(v, GenericDeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GenericDeviceStatusModel`")
        else:
            match += 1
        # validate data type: FleetControlPrinterGroupDeviceStatusModel
        if not isinstance(v, FleetControlPrinterGroupDeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FleetControlPrinterGroupDeviceStatusModel`")
        else:
            match += 1
        # validate data type: Form4FamilyDeviceStatusModel
        if not isinstance(v, Form4FamilyDeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Form4FamilyDeviceStatusModel`")
        else:
            match += 1
        # validate data type: Form3FamilyDeviceStatusModel
        if not isinstance(v, Form3FamilyDeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Form3FamilyDeviceStatusModel`")
        else:
            match += 1
        # validate data type: Fuse1DeviceStatusModel
        if not isinstance(v, Fuse1DeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Fuse1DeviceStatusModel`")
        else:
            match += 1
        # validate data type: Form2DeviceStatusModel
        if not isinstance(v, Form2DeviceStatusModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Form2DeviceStatusModel`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in DeviceStatusModel with oneOf schemas: FleetControlPrinterGroupDeviceStatusModel, Form2DeviceStatusModel, Form3FamilyDeviceStatusModel, Form4FamilyDeviceStatusModel, Fuse1DeviceStatusModel, GenericDeviceStatusModel. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in DeviceStatusModel with oneOf schemas: FleetControlPrinterGroupDeviceStatusModel, Form2DeviceStatusModel, Form3FamilyDeviceStatusModel, Form4FamilyDeviceStatusModel, Fuse1DeviceStatusModel, GenericDeviceStatusModel. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into GenericDeviceStatusModel
        try:
            instance.actual_instance = GenericDeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into FleetControlPrinterGroupDeviceStatusModel
        try:
            instance.actual_instance = FleetControlPrinterGroupDeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into Form4FamilyDeviceStatusModel
        try:
            instance.actual_instance = Form4FamilyDeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into Form3FamilyDeviceStatusModel
        try:
            instance.actual_instance = Form3FamilyDeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into Fuse1DeviceStatusModel
        try:
            instance.actual_instance = Fuse1DeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into Form2DeviceStatusModel
        try:
            instance.actual_instance = Form2DeviceStatusModel.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FleetControlPrinterGroupDeviceStatusModel, Form2DeviceStatusModel, Form3FamilyDeviceStatusModel, Form4FamilyDeviceStatusModel, Fuse1DeviceStatusModel, GenericDeviceStatusModel]]:
