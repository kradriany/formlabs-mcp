...
class SLA(BaseModel):
    ...
    unsupported_volume_ml: Union[StrictFloat, StrictInt] = Field(description="The total volume of all models in the scene, not including their supports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unsupported_volume_ml": obj.get("unsupported_volume_ml")
        })
        return _obj
