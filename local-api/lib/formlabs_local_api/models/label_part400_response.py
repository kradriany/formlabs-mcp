...
class LabelPart400Response(BaseModel):
    """
    LabelPart400Response
    """ # noqa: E501
    error: Optional[LabelPart400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": LabelPart400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
