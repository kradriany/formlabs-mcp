...
class Form4FamilyDeviceStatusModelAllOfCartridgeData(BaseModel):
    """
    Form4FamilyDeviceStatusModelAllOfCartridgeData
    """ # noqa: E501
    cartridge_material_code: StrictStr = Field(alias="cartridgeMaterialCode")
    cartridge_estimated_volume_dispensed_m_l: Union[StrictFloat, StrictInt] = Field(alias="cartridgeEstimatedVolumeDispensed_mL")
    cartridge_original_volume_m_l: Union[StrictFloat, StrictInt] = Field(alias="cartridgeOriginalVolume_mL")
    __properties: ClassVar[List[str]] = ["cartridgeMaterialCode", "cartridgeEstimatedVolumeDispensed_mL", "cartridgeOriginalVolume_mL"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cartridgeMaterialCode": obj.get("cartridgeMaterialCode"),
            "cartridgeEstimatedVolumeDispensed_mL": obj.get("cartridgeEstimatedVolumeDispensed_mL"),
            "cartridgeOriginalVolume_mL": obj.get("cartridgeOriginalVolume_mL")
        })
        return _obj
