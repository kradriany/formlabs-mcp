...
class Fuse1DeviceStatusModel(BaseModel):
    """
    ...
    ready_to_print_now: StrictBool = Field(description="If the default behavior for newly uploaded jobs is to start printing them automatically. If false, uploaded jobs will be added to the printing queue.")
