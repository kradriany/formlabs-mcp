...
class FleetControlPrinterGroupDeviceStatusModelAllOfPrinters(BaseModel):
    """
    FleetControlPrinterGroupDeviceStatusModelAllOfPrinters
    """ # noqa: E501
    id: Optional[StrictStr] = None
    machine_type_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "machine_type_id"]
