...
class Form2DeviceStatusModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "product_name", "status", "is_connected", "connection_type", "ip_address", "firmware_version", "ready_to_print_now", "estimated_print_time_remaining_ms", "tank_id", "tank_material_code", "cartridge_data"]
