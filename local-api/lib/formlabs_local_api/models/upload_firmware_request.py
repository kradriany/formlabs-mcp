...
class UploadFirmwareRequest(BaseModel):
    ...
    """ # noqa: E501
    printer: StrictStr = Field(description="Local network IP address, or machine serial name to upload firmware to")
    file_path: StrictStr = Field(description="Local file path to the firmware .formware or .formware2 file")
    __properties: ClassVar[List[str]] = ["printer", "file_path"]
