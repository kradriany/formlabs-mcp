...
class AutoLayoutRequestCustomBounds(BaseModel):
    """
    Bounds to keep selected models inside in the layout operation (default is the maximum that will fit on the build platform)
    """ # noqa: E501
    x_min_mm: Optional[Union[StrictFloat, StrictInt]] = None
    x_max_mm: Optional[Union[StrictFloat, StrictInt]] = None
    y_min_mm: Optional[Union[StrictFloat, StrictInt]] = None
    y_max_mm: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["x_min_mm", "x_max_mm", "y_min_mm", "y_max_mm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "x_min_mm": obj.get("x_min_mm"),
            "x_max_mm": obj.get("x_max_mm"),
            "y_min_mm": obj.get("y_min_mm"),
            "y_max_mm": obj.get("y_max_mm")
        })
        return _obj
