...
class PrintValidationResultModelPerModelResultsValue(BaseModel):
    """
    PrintValidationResultModelPerModelResultsValue
    """ # noqa: E501
    cups: Optional[StrictInt] = Field(default=None, description="The number of cups in the model")
    unsupported_minima: Optional[StrictInt] = Field(default=None, description="The number of unsupported minima in the model")
    undersupported: Optional[StrictBool] = Field(default=None, description="Whether the model is undersupported")
    has_seamline: Optional[StrictBool] = Field(default=None, description="Whether the model has a seamline")
    __properties: ClassVar[List[str]] = ["cups", "unsupported_minima", "undersupported", "has_seamline"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cups": obj.get("cups"),
            "unsupported_minima": obj.get("unsupported_minima"),
            "undersupported": obj.get("undersupported"),
            "has_seamline": obj.get("has_seamline")
        })
        return _obj
