...
class PackAndCageRequest(BaseModel):
    """
    PackAndCageRequest
    """ # noqa: E501
    models: ModelsSelectionModel
    packing_type: Optional[PackingTypeModel] = None
    cage_label: Optional[StrictStr] = Field(default=None, description="The label engraved on the part cage.")
    generate_mesh_label: Optional[StrictBool] = Field(default=None, description="Whether or not to physically emboss the label of the part cage")
    model_spacing_mm: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Minimum distance between models in the cage.")
    bar_spacing_mm: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Space between the bars of the cage")
    bar_thickness_mm: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="The space between the bars of the cage")
    bar_width_mm: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Width of the bars of the cage. Defaults to the same as bar_thickness_mm")
    distance_to_cage_mm: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Extra space between the models and the cage walls")
    enable_round_edges: Optional[StrictBool] = Field(default=False, description="Rounds the edges of external cage corners")
    enable_square_bars: Optional[StrictBool] = Field(default=True, description="Generate square bars for the cage")
    __properties: ClassVar[List[str]] = ["models", "packing_type", "cage_label", "generate_mesh_label", "model_spacing_mm", "bar_spacing_mm", "bar_thickness_mm", "bar_width_mm", "distance_to_cage_mm", "enable_round_edges", "enable_square_bars"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of packing_type
        if self.packing_type:
            _dict['packing_type'] = self.packing_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "packing_type": PackingTypeModel.from_dict(obj["packing_type"]) if obj.get("packing_type") is not None else None,
            "cage_label": obj.get("cage_label"),
            "generate_mesh_label": obj.get("generate_mesh_label"),
            "model_spacing_mm": obj.get("model_spacing_mm"),
            "bar_spacing_mm": obj.get("bar_spacing_mm"),
            "bar_thickness_mm": obj.get("bar_thickness_mm"),
            "bar_width_mm": obj.get("bar_width_mm"),
            "distance_to_cage_mm": obj.get("distance_to_cage_mm"),
            "enable_round_edges": obj.get("enable_round_edges") if obj.get("enable_round_edges") is not None else False,
            "enable_square_bars": obj.get("enable_square_bars") if obj.get("enable_square_bars") is not None else True
        })
        return _obj
