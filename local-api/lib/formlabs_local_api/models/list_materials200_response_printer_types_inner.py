...
class ListMaterials200ResponsePrinterTypesInner(BaseModel):
    """
    ListMaterials200ResponsePrinterTypesInner
    """ # noqa: E501
    label: Optional[StrictStr] = None
    build_volume_dimensions_mm: Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=3, max_length=3)]] = None
    supported_machine_type_ids: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = None
    supported_product_names: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = None
    materials: Optional[List[ListMaterials200ResponsePrinterTypesInnerMaterialsInner]] = None
    __properties: ClassVar[List[str]] = ["label", "build_volume_dimensions_mm", "supported_machine_type_ids", "supported_product_names", "materials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "build_volume_dimensions_mm": obj.get("build_volume_dimensions_mm"),
            "supported_machine_type_ids": obj.get("supported_machine_type_ids"),
            "supported_product_names": obj.get("supported_product_names"),
            "materials": [ListMaterials200ResponsePrinterTypesInnerMaterialsInner.from_dict(_item) for _item in obj["materials"]] if obj.get("materials") is not None else None
        })
        return _obj
