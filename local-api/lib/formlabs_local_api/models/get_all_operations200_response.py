...
class GetAllOperations200Response(BaseModel):
    """
    GetAllOperations200Response
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of operations")
    operations: Optional[List[GetAllOperations200ResponseOperationsInner]] = None
    __properties: ClassVar[List[str]] = ["count", "operations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "operations": [GetAllOperations200ResponseOperationsInner.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
