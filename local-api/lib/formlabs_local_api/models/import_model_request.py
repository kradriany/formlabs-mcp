...
class ImportModelRequest(BaseModel):
    ...
    repair_behavior: Optional[RepairBehaviorModel] = RepairBehaviorModel.ERROR
    ...
    __properties: ClassVar[List[str]] = ["file", "repair_behavior", "name", "position", "orientation", "scale", "units", "lock"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file": obj.get("file"),
            "repair_behavior": obj.get("repair_behavior") if obj.get("repair_behavior") is not None else RepairBehaviorModel.ERROR,
            "name": obj.get("name"),
