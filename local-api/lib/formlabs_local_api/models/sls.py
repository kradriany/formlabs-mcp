...
class SLS(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_powder_ml": obj.get("total_powder_ml"),
            "total_powder_kg": obj.get("total_powder_kg"),
            "total_sintered_powder_ml": obj.get("total_sintered_powder_ml"),
            "total_sintered_powder_kg": obj.get("total_sintered_powder_kg"),
            "mass_packing_density": obj.get("mass_packing_density")
        })
        return _obj
