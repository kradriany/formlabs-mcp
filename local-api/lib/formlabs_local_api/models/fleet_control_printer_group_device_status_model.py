...
class FleetControlPrinterGroupDeviceStatusModel(BaseModel):
    """
    ...
    dashboard_group_id: StrictStr
    dashboard_queue_id: StrictStr
    queue_paused: StrictBool
    has_form_auto: StrictBool
    supported_machine_type_ids: List[StrictStr]
    printers: List[FleetControlPrinterGroupDeviceStatusModelAllOfPrinters]
    __properties: ClassVar[List[str]] = ["id", "product_name", "status", "is_connected", "connection_type", "ip_address", "firmware_version", "ready_to_print_now", "dashboard_group_id", "dashboard_queue_id", "queue_paused", "has_form_auto", "supported_machine_type_ids", "printers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dashboard_group_id": obj.get("dashboard_group_id"),
            "dashboard_queue_id": obj.get("dashboard_queue_id"),
            "queue_paused": obj.get("queue_paused"),
            "has_form_auto": obj.get("has_form_auto"),
            "supported_machine_type_ids": obj.get("supported_machine_type_ids"),
            "printers": [FleetControlPrinterGroupDeviceStatusModelAllOfPrinters.from_dict(_item) for _item in obj["printers"]] if obj.get("printers") is not None else None
        })
        return _obj
