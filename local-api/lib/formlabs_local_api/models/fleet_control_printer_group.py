...
class FleetControlPrinterGroup(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "product_name", "status", "is_connected", "connection_type", "firmware_version", "dashboard_group_id", "dashboard_queue_id"]
