...
class ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner(BaseModel):
    """
    ListMaterials200ResponsePrinterTypesInnerMaterialsInnerMaterialSettingsInner
    """ # noqa: E501
    label: Optional[StrictStr] = None
    scene_settings: Optional[SceneTypeModel] = None
    __properties: ClassVar[List[str]] = ["label", "scene_settings"]
