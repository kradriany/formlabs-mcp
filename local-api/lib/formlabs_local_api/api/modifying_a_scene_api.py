...
class ModifyingASceneApi:
    ...
    def _add_drain_holes_serialize(
        ...
        if add_drain_holes_request is not None:
            _body_params = add_drain_holes_request
    ...
    def _auto_layout_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if auto_layout_request is not None:
            _body_params = auto_layout_request
    ...
    def _auto_orient_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if auto_orient_request is not None:
            _body_params = auto_orient_request
    ...
    def _auto_pack_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if auto_pack_request is not None:
            _body_params = auto_pack_request
    ...
    def _auto_support_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if auto_support_request is not None:
            _body_params = auto_support_request
    ...
    def create_scene(
        self,
        scene_type_model: Annotated[SceneTypeModel, Field(description="Create a scene with a given printing setup. For a full list of possible settings, call the GET /list-materials/ endpoint ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param scene_type_model: Create a scene with a given printing setup. For a full list of possible settings, call the GET /list-materials/ endpoint  (required)
        :type scene_type_model: SceneTypeModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._create_scene_serialize(
            scene_type_model=scene_type_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_scene_with_http_info(
        self,
        scene_type_model: Annotated[SceneTypeModel, Field(description="Create a scene with a given printing setup. For a full list of possible settings, call the GET /list-materials/ endpoint ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_scene_without_preload_content(
        self,
        scene_type_model: Annotated[SceneTypeModel, Field(description="Create a scene with a given printing setup. For a full list of possible settings, call the GET /list-materials/ endpoint ")],
        _request_timeout: Union[
            None,
    ...
    def _duplicate_model_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if duplicate_model_request is not None:
            _body_params = duplicate_model_request
    ...
    def _hollow_model_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if hollow_model_request is not None:
            _body_params = hollow_model_request
    ...
    def _label_part_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if label_part_request is not None:
            _body_params = label_part_request
    ...
    def load_form_file(
        self,
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path to the .form file to load")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param load_form_file_request: Full path to the .form file to load (required)
        :type load_form_file_request: LoadFormFileRequest
        :param var_async: Whether to run the operation asynchronously
        :type var_async: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._load_form_file_serialize(
            load_form_file_request=load_form_file_request,
            var_async=var_async,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def load_form_file_with_http_info(
        self,
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path to the .form file to load")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def load_form_file_without_preload_content(
        self,
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path to the .form file to load")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
        _request_timeout: Union[
    ...
    def _load_form_file_serialize(
        self,
        load_form_file_request,
        var_async,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if load_form_file_request is not None:
            _body_params = load_form_file_request
    ...
    def _replace_model_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if replace_model_request is not None:
            _body_params = replace_model_request
    ...
    def _scan_to_model_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if scan_to_model_request is not None:
            _body_params = scan_to_model_request
