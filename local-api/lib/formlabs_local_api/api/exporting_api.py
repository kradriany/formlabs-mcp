...
class ExportingApi:
    ...
    def save_form_file(
        ...
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path where the file should be saved")],
        ...
        :type scene_id: str
        :param load_form_file_request: Full path where the file should be saved (required)
        ...
        _param = self._save_form_file_serialize(
            scene_id=scene_id,
    ...
    @validate_call
    def save_form_file_with_http_info(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path where the file should be saved")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
    ...
    @validate_call
    def save_form_file_without_preload_content(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        load_form_file_request: Annotated[LoadFormFileRequest, Field(description="Full path where the file should be saved")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
    ...
    def _save_form_file_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/scene/{scene_id}/save-form/',
    ...
    def save_fps_file(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_fps_file_request: Annotated[SaveFpsFileRequest, Field(description="Full path where the FPS file should be saved")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param scene_id: The unique identifier of the scene (required)
        :type scene_id: str
        :param save_fps_file_request: Full path where the FPS file should be saved (required)
        :type save_fps_file_request: SaveFpsFileRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._save_fps_file_serialize(
            scene_id=scene_id,
            save_fps_file_request=save_fps_file_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def save_fps_file_with_http_info(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_fps_file_request: Annotated[SaveFpsFileRequest, Field(description="Full path where the FPS file should be saved")],
        _request_timeout: Union[
    ...
    @validate_call
    def save_fps_file_without_preload_content(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_fps_file_request: Annotated[SaveFpsFileRequest, Field(description="Full path where the FPS file should be saved")],
        _request_timeout: Union[
    ...
    def _save_fps_file_serialize(
        self,
        scene_id,
        save_fps_file_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if save_fps_file_request is not None:
            _body_params = save_fps_file_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/scene/{scene_id}/save-fps-file/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def save_screenshot(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_screenshot_request: Annotated[SaveScreenshotRequest, Field(description="Full path where the image should be saved")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param scene_id: The unique identifier of the scene (required)
        :type scene_id: str
        :param save_screenshot_request: Full path where the image should be saved (required)
        :type save_screenshot_request: SaveScreenshotRequest
        :param var_async: Whether to run the operation asynchronously
        :type var_async: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._save_screenshot_serialize(
            scene_id=scene_id,
    ...
    @validate_call
    def save_screenshot_with_http_info(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_screenshot_request: Annotated[SaveScreenshotRequest, Field(description="Full path where the image should be saved")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
    ...
    @validate_call
    def save_screenshot_without_preload_content(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        save_screenshot_request: Annotated[SaveScreenshotRequest, Field(description="Full path where the image should be saved")],
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
    ...
    def _save_screenshot_serialize(
        self,
        scene_id,
        save_screenshot_request,
        var_async,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if save_screenshot_request is not None:
            _body_params = save_screenshot_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/scene/{scene_id}/save-screenshot/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
