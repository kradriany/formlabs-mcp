...
class GettingSceneInformationDeprecatedApi:
    ...
    @validate_call
    def estimate_print_time_deprecated(
        self,
        ...
        _param = self._estimate_print_time_deprecated_serialize(
    ...
    @validate_call
    def estimate_print_time_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def estimate_print_time_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _estimate_print_time_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def get_print_validation_deprecated(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_print_validation_deprecated_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_print_validation_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_print_validation_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_print_validation_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_scene_deprecated(
        ...
        _param = self._get_scene_deprecated_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_scene_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_scene_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_scene_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def get_scene_interferences_deprecated(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_scene_interferences_deprecated_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_scene_interferences_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_scene_interferences_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_scene_interferences_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
