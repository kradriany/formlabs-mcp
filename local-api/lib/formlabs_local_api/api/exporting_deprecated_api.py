...
class ExportingDeprecatedApi:
    ...
    def save_form_file_deprecated(
        ...
        _param = self._save_form_file_deprecated_serialize(
    ...
    @validate_call
    def save_form_file_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def save_form_file_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _save_form_file_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def save_fps_file_deprecated(
        ...
        _param = self._save_fps_file_deprecated_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def save_fps_file_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def save_fps_file_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _save_fps_file_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def save_screenshot_deprecated(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._save_screenshot_deprecated_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def save_screenshot_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def save_screenshot_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _save_screenshot_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
