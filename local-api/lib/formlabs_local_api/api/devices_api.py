...
class DevicesApi:
    ...
    def upload_firmware(
        self,
        upload_firmware_request: UploadFirmwareRequest,
        var_async: Annotated[Optional[StrictBool], Field(description="Whether to run the operation asynchronously")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param upload_firmware_request: (required)
        :type upload_firmware_request: UploadFirmwareRequest
        :param var_async: Whether to run the operation asynchronously
        :type var_async: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._upload_firmware_serialize(
            upload_firmware_request=upload_firmware_request,
            var_async=var_async,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _upload_firmware_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upload_firmware_request is not None:
            _body_params = upload_firmware_request
