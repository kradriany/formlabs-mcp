...
class RemoteAccessDeprecatedApi:
    ...
    def print_deprecated(
        ...
        _param = self._print_deprecated_serialize(
    ...
    @validate_call
    def print_deprecated_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def print_deprecated_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _print_deprecated_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
